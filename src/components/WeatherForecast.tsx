...
export const WeatherForecast = ({ weatherForecastData }: { weatherForecastData: WeatherForecastData }) => {
            ...
            <div className="flex flex-nowrap overflow-x-auto justify-start items-center">
                ...
                <div key={index} className="m-4 p-4 bg-green-50 rounded-lg shadow-md h-[260px] min-w-[240px] flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        {day.clouds != null && day.clouds <= 100 && <Value label="Cloudy" value={`${day.clouds}%`} />}
                        {day.rain != null && day.rain <= 1 && <Value label="Rain" value={`${day.rain * 100}%`} />}
                    </div>
                </div>
                ))}
            </div>
